...
filter data
display as candle stick plot with a liine for each company
each line can be toggled on and off as it is a plotly object, this allows for quick comparisons of companies
once data is displayed, we will look for repeating patterns in the data as well as correlate ket historical events to distinct points in the data
...
fig.update_layout(title='Candlestick Chart for 14 Companies <br><sup>Kaggle via Yahoo Finance | Tidy Tuesday 2023',
                  xaxis_title='Date',
                  yaxis_title='Price',
