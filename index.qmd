...
# Customize the layout
fig.update_layout(
    title='Stock Close Prices Over Time (2010 - 2022)<br><sup>Kaggle via Yahoo Finance | Tidy Tuesday 2023',
    xaxis_title='Date',
...
# Create a layout
layout = go.Layout(
    title='Average Volume Traded per Year for Each Stock Symbol <br><sup>Kaggle via Yahoo Finance | Tidy Tuesday 2023',
